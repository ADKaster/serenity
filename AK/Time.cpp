...
Time now_time_from_filetime()
{
    ...
    // To to  Unix Epoch, subtract the number of hundred nanosecond intervals from Jan 1, 1601 to Jan 1, 1970.
...
Time now_time_from_query_performance_counter()
{
    ...
    // FIXME: Limit to microseconds for now, but could probalby use nanos?
