...
#if !defined(AK_OS_MACOS) && !defined(AK_OS_EMSCRIPTEN) && !defined(AK_OS_WASI) && !defined(AK_OS_GNU_HURD)
#    include <sys/prctl.h>
#endif
...
#elif !defined(AK_OS_MACOS) && !defined(AK_OS_EMSCRIPTEN) && !defined(AK_OS_WASI)
