...
#define __JS_ENUMERATE(ClassName, snake_name, PrototypeName, ConstructorName, ArrayType) \
    JS_IMPLEMENT_NATIVE_ERROR_CONSTRUCTOR(ClassName, snake_name, PrototypeName, ConstructorName, ArrayType, (*realm.intrinsics().snake_name##_prototype()), (&Intrinsics::snake_name##_prototype))
